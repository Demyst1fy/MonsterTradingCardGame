...
namespace SWEN1.MTCG.Test.Server.Test
{
    public class HandleActionTest
    {
        ...
        public void Init()
        {
            ...
            _allMatches = new ConcurrentQueue<Match>();
        }
        ...
        public void Test_HandleRegistration()
        {
            ...
            _action.Verify(mock => mock.HandleRegistration(It.IsAny<string>()), Times.Once);
        ...
        public void Test_HandleLogin()
        {
            ...
            _action.Verify(mock => mock.HandleLogin(It.IsAny<string>()), Times.Once);
        }
        ...
        public void Test_HandleCreatePackage()
        {
            ...
            _serviceHandler.HandleRequest(request, ref _allMatches);
            _action.Verify(mock => mock.HandleCreatePackage(It.IsAny<string>(), It.IsAny<string>()), Times.Once);
        ...
        public void Test_HandleShowTransaction()
        {
            ...
            _action.Verify(mock => mock.HandleShowTransactions(It.IsAny<string>()), Times.Once);
        }
        ...
        public void Test_HandleShowDeck()
        {
            ...
            _serviceHandler.HandleRequest(request, ref _allMatches);
            _action.Verify(mock => mock.HandleShowDeck(It.IsAny<string>()), Times.Once);
        ...
        public void Test_HandleConfigureDeck()
        {
            ...
            _action.Verify(mock => mock.HandleConfigureDeck(It.IsAny<string>(), It.IsAny<string>()), Times.Once);
        }
    }
}